...
exports.lineData = exports.userDataRegister = exports.checkLineInvitation = exports.backUpInventoryLineData = exports.registerLine = exports.deleteLine = exports.lineUpdateStatus = exports.newLineRegister = exports.getAllLine = exports.getLines = exports.createLine = void 0;
...
const createLine = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const newLine = yield tx.line.create({
                data: {
                    name: body.name,
            ...
            const hrmoPosition = yield tx.position.create({
                data: {
                    name: "Human Resources Management Officer",
                    departmentId: department.id,
                    lineId: newLine.id,
                    salaryGradeId: (_b = (_a = sg[sg.length - 1]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null,
                },
            });
            // 2. UnitPosition for the HR dept.
            const hrmoUnitPosition = yield tx.unitPosition.create({
                data: {
                    departmentId: department.id,
                    lineId: newLine.id,
            ...
            const hrmoSlot = yield tx.positionSlot.create({
                data: {
                    unitPositionId: hrmoUnitPosition.id,
                    positionId: hrmoPosition.id,
                    salaryGradeId: (_d = (_c = sg[sg.length - 1]) === null || _c === void 0 ? void 0 : _c.id) !== null && _d !== void 0 ? _d : null,
                    occupied: false,
                },
            });
            ...
            return {
                ...
                sgId: (_f = (_e = sg[sg.length - 1]) === null || _e === void 0 ? void 0 : _e.id) !== null && _f !== void 0 ? _f : sg[0].id,
        ...
        (0, handler_1.sendEmail)("New Line Registration — Complete Your HRMO Account", body.email, `Hello,
...
LGU Gasan`, "Gasan LGU HR").catch((e) => console.warn("[createLine] HRMO email failed:", e));
    ...
    try {
        ...
        if (body.status !== 1) {
            try {
                ...
                notificationSocket.emitForceLogoutMany(users.map((u) => u.id), `This line has been ${(_a = handler_1.lineStatus[body.status]) !== null && _a !== void 0 ? _a : "deactivated"} by an administrator.`);
            }
            catch (e) {
...
const registerLine = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const effectiveSalaryGradeId = (_k = (_g = (_f = body.sgId) !== null && _f !== void 0 ? _f : slot.salaryGradeId) !== null && _g !== void 0 ? _g : (_j = (_h = slot.unitPosition) === null || _h === void 0 ? void 0 : _h.position) === null || _j === void 0 ? void 0 : _j.salaryGradeId) !== null && _k !== void 0 ? _k : null;
            ...
            if (!effectiveDepartmentId) {
                throw new errors_1.ValidationError("Slot has no resolvable department — check that the UnitPosition references a Department.");
            }
            ...
            const user = yield tx.user.create({
                data: Object.assign({ firstName: application.firstname, lastName: application.lastname, username: account.username, accountId: account.id, email: application.email, emailIv: application.emailIv, lineId: body.lineId, positionId: effectivePositionId, departmentId: effectiveDepartmentId }, (effectiveSalaryGradeId
            ...
            yield tx.positionSlot.update({
                ...
                data: {
                    ...
                    salaryGradeId: effectiveSalaryGradeId !== null && effectiveSalaryGradeId !== void 0 ? effectiveSalaryGradeId : body.sgId,
                    occupied: true,
                },
            });
...
const lineData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const params = req.query;
    if (!params.id) {
        throw new errors_1.ValidationError("INVALID REQUIRED ID");
    }
    try {
        ...
        if (!response) {
            throw new errors_1.NotFoundError("LINE NOT FOUND");
        }
        return res.code(200).send(response);
    }
    catch (error) {
