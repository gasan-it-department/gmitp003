...
exports.prescribeTransaction = exports.prescriptionProgressUpdate = exports.prescriptionProgress = exports.prescriptionDispense = exports.prescriptionProgres = exports.prescriptionPrescribeMed = exports.prescriptionData = exports.prescriptionList = exports.createPrescriptions = exports.prescriptions = void 0;
...
const prescriptions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const createPrescriptions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const body = req.body;
    console.log(body);
    try {
        const refNumber = yield (0, handler_1.generatePrescriptionRef)();
        const age = body.birthday
            ? computeAgeFromBirthday(body.birthday)
            : (_a = body.age) !== null && _a !== void 0 ? _a : "N/A";
        const response = yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let resolvedPatientId = (_a = body.patientId) !== null && _a !== void 0 ? _a : "";
            if (!resolvedPatientId) {
                const newPatient = yield tx.patient.create({
                    data: {
                        firstname: (_b = body.firstname) !== null && _b !== void 0 ? _b : "",
                        lastname: (_c = body.lastname) !== null && _c !== void 0 ? _c : "",
            ...
            const prescription = yield tx.prescription.create({
                data: {
                    ...
                    externalSource: body.external
                        ? ((_d = body.externalSource) === null || _d === void 0 ? void 0 : _d.trim()) || null
                        : null,
                    progress: {
                        create: { step: 0 },
                    },
            ...
            const medNotif = yield tx.medicineNotification.create({
                data: Object.assign({ userId: body.userId, view: 0, path: `prescription/${prescription.id}`, message: `${user.lastName}, ${user.firstName} - submitted prescription for ${body.lastname}, ${body.firstname}`, title: "New Prescription", lineId: body.lineId }, notRequired),
                select: {
                    id: true,
                    userId: true,
                    title: true,
            ...
            try {
                ...
                notificationSocket.emitMedicineNotification(medNotif.lineId, {
                    ...
                    path: (_e = medNotif.path) !== null && _e !== void 0 ? _e : undefined,
            ...
            const pharmacyUsers = yield tx.module.findMany({
                where: {
                    lineId: body.lineId,
                    OR: [
...
const prescriptionList = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield prisma_1.prisma.prescription.findMany({
...
const prescriptionData = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const params = req.query;
    if (!params.id)
        throw new errors_1.ValidationError("BAD_REQUEST");
    try {
        const response = yield prisma_1.prisma.prescription.findUnique({
            where: {
                id: params.id,
            },
            include: {
...
exports.prescriptionData = prescriptionData;
const prescriptionPrescribeMed = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const params = req.query;
    if (!params.id)
        throw new errors_1.ValidationError("BAD_REQUEST");
    try {
        ...
        yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            const prescribeMeds = yield tx.precribeMedicine.findMany({
                where: {
                    prescriptionId: params.id,
                },
            });
            if (prescribeMeds.length === 0)
            ...
            const stocks = yield tx.medicineStock.groupBy({
                by: [
                    "medicineId",
                    "expiration",
                    "perQuantity",
        ...
        const response = yield prisma_1.prisma.precribeMedicine.findMany({
            where: {
                prescriptionId: params.id,
            },
            skip: cursor ? 1 : 0,
...
exports.prescriptionPrescribeMed = prescriptionPrescribeMed;
const prescriptionProgres = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const params = req.query;
    if (!params.id)
        throw new errors_1.ValidationError("BAD_REQUEST");
    try {
        ...
        const response = yield prisma_1.prisma.prescriptionProgress.findMany({
            where: {
                prescriptionId: params.id,
            },
            take: limit,
...
exports.prescriptionProgres = prescriptionProgres;
const prescriptionDispense = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    ...
    try {
        ...
        const stockStorages = yield prisma_1.prisma.medicineStock.findMany({
            where: { id: { in: stockIds } },
            select: { medicineStorageId: true },
        });
        yield (0, storageAccessController_1.assertStorageAccess)(body.userId, stockStorages.map((s) => s.medicineStorageId), "dispense");
        yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f;
            const prescription = yield tx.prescription.findUnique({
                where: {
                    id: body.id,
                },
                include: {
            ...
            console.log("Log 2 - Prescription found:", prescription === null || prescription === void 0 ? void 0 : prescription.id);
            const medicineStocks = yield tx.medicineStock.findMany({
                where: {
                    id: {
                        in: stockIds,
                    },
            ...
            if (prescription.status === 2)
                throw new errors_1.ValidationError("Prescripton already processed");
            ...
            if (!prescription.patientId)
                throw new errors_1.ValidationError("Cannot dispense: patient record no longer exists.");
            ...
            yield Promise.all(body.prescribeMed.map((item) => {
            ...
            const transaction = yield tx.medicineTransaction.create({
                data: {
                    prescriptionId: prescription.id,
            ...
            for (let i = 0; i < medicineStocks.length; i++) {
                ...
                try {
                    const toDispense = body.prescribeMed.find((med) => med.medId === item.medicineId);
                    ...
                    console.log("Log 7 - Quantity:", currentBoxes, "PerUnit:", perBox, "ToRelease:", toRelease, "Loose: ", currentStockPieces);
                    ...
                    yield (0, medicineAlerts_1.checkAndNotifyLowStock)(tx, item.id);
                    yield tx.medicineTransactionItem.create({
                        data: {
                            medicineTransactionId: transaction.id,
                            prescribeQuantity: toDispense.prescribeQuantity,
                            releasedQuantity: toDispense.quantity,
                            medicineStorageId: (_a = item.MedicineStorage) === null || _a === void 0 ? void 0 : _a.id,
                ...
                data: {
                    ...
                    message: `Dispensed Medicine: Ref. #: ${prescription.refNumber}` +
                        (prescription.external
                            ? ` — EXTERNAL prescription${prescription.externalSource ? ` (${prescription.externalSource})` : ""}`
                            : ""),
                    lineId: prescription.lineId,
                },
            });
            ...
            const dispenser = yield tx.user.findUnique({
                where: { id: body.userId },
            ...
            const dispWho = dispenser
                ...
                : "Pharmacy";
            const dispPatient = yield tx.patient.findUnique({
                where: { id: prescription.patientId },
                select: { firstname: true, lastname: true },
            });
            const dispFor = [dispPatient === null || dispPatient === void 0 ? void 0 : dispPatient.lastname, dispPatient === null || dispPatient === void 0 ? void 0 : dispPatient.firstname]
                .filter((x) => x && String(x).trim())
                .join(", ") || "a patient";
            if (prescription.lineId) {
                const dispNotif = yield tx.medicineNotification.create({
                    data: {
                        userId: body.userId,
                        view: 0,
                ...
                try {
                    ...
                    notificationSocket.emitMedicineNotification(dispNotif.lineId, {
                        ...
                        path: (_b = dispNotif.path) !== null && _b !== void 0 ? _b : undefined,
                        timestamp: typeof dispNotif.timestamp === "string"
                            ? dispNotif.timestamp
            ...
            try {
                const releasedItems = yield tx.precribeMedicine.findMany({
                ...
                const items = releasedItems
                    ...
                    return ({
                        ...
                        quantity: (_b = (_a = m.releaseQuantity) !== null && _a !== void 0 ? _a : m.quantity) !== null && _b !== void 0 ? _b : 0,
                    });
                });
                if (items.length > 0 && prescription.lineId) {
                    yield (0, medicineController_1.createDispenseRecord)(tx, {
                        lineId: prescription.lineId,
                        kind: 1,
                        dispenser: {
                            id: body.userId,
                            username: null,
                            name: dispenser
                                ? `${(_c = dispenser.firstName) !== null && _c !== void 0 ? _c : ""} ${(_d = dispenser.lastName) !== null && _d !== void 0 ? _d : ""}`.trim()
                                : null,
                        },
                        patientName: dispFor,
                        patientId: prescription.patientId,
                        note: (_e = prescription.condtion) !== null && _e !== void 0 ? _e : null,
                        external: !!prescription.external,
                        externalSource: (_f = prescription
                            .externalSource) !== null && _f !== void 0 ? _f : null,
                        prescriptionId: prescription.id,
...
exports.prescriptionDispense = prescriptionDispense;
const prescriptionProgress = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const params = req.query;
    console.log(params);
    if (!params.id)
        throw new errors_1.ValidationError("BAD_REQUEST");
...
exports.prescriptionProgress = prescriptionProgress;
const prescriptionProgressUpdate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const body = req.body;
    try {
        yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            const prescription = yield tx.prescription.findUnique({
...
exports.prescriptionProgressUpdate = prescriptionProgressUpdate;
const prescribeTransaction = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const params = req.query;
    if (!params.id)
...
exports.prescribeTransaction = prescribeTransaction;
