...
const createPrescriptions = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const response = yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield tx.medicineNotification.create({
                data: Object.assign({ userId: body.userId, view: 0, path: `prescription/${prescription.id}`, message: `${user.lastName}, ${user.firstName} - submitted prescripton for ${body.lastname}, ${body.firstname} `, title: "New Prescription", lineId: body.lineId }, notRequired),
            });
            return prescription;
        }));
...
const prescriptionDispense = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield prisma_1.prisma.$transaction((tx) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const totalStocks = Array.from(stocks.values()).reduce((sum, value) => sum + parseInt(value, 10), 0);
            yield Promise.all(body.prescribeMed.map((item) => tx.precribeMedicine.update({
                where: {
                    id: item.id,
                },
                data: {
