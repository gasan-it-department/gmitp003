...
const supply = (fastify) => {
    ...
    fastify.post("/supply/restock", { preHandler: handler_1.authenticated }, supplyController_1.restockSupply);
    fastify.get("/supply/container-datasets", { preHandler: handler_1.authenticated }, supplyController_1.containerDatasets);
    ...
    fastify.patch("/supply/transaction/update", { preHandler: handler_1.authenticated }, supplyController_1.updateSupplyDispense);
    fastify.get("/supply/inventory/timebase/report", { preHandler: handler_1.authenticated }, supplyController_1.timebaseReport);
    fastify.get("/supply/inventory/timebase/report/export", { preHandler: handler_1.authenticated }, supplyController_1.timebaseReportExport);
    fastify.post("/supply/upload-excel", { preHandler: handler_1.authenticated }, supplyController_1.uploadBulkExcel);
};
