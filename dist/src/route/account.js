...
const accounts = (fastify) => {
    fastify.get("/accounts", { preHandler: handler_1.adminAuthenticated }, accountController_1.accountList);
    ...
    fastify.patch("/account/status", { preHandler: handler_1.adminAuthenticated }, accountController_1.adminSetAccountStatus);
    fastify.delete("/account/delete", { preHandler: handler_1.adminAuthenticated }, accountController_1.adminDeleteAccount);
